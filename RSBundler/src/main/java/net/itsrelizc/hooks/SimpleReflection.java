...
public class SimpleReflection {
	...
	public static void sendAllPacket(Object packet) throws Exception {
		for (Player p : Bukkit.getOnlinePlayers()) {
			...
			connection.getClass().getMethod("sendPacket", SimpleReflection.getClass("{nms}.Packet")).invoke(connection,
					packet);
		}
	}
	...
	public static void sendPlayerPacket(Player p, Object packet) throws Exception {
		Object nmsPlayer = getNmsPlayer(p);
		Object connection = nmsPlayer.getClass().getField("playerConnection").get(nmsPlayer);
		connection.getClass().getMethod("sendPacket", SimpleReflection.getClass("{nms}.Packet")).invoke(connection, packet);
	}
}